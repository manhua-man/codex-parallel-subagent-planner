...
- **Streamlined SKILL.md**: Reduced to ~50 lines of clean, pragmatic instructions focused 100% on real cognitive value (Split decision, file scope isolation, execution order, clean prompts, main thread integration).
